Watcher [![GoDoc](https://godoc.org/github.com/golang-devops/go-watcher?status.svg)](https://godoc.org/github.com/golang-devops/go-watcher) [![Build Status](https://travis-ci.org/canthefason/go-watcher.svg?branch=master)](https://travis-ci.org/canthefason/go-watcher)
=======
...
## Installation
  ...
  `go get github.com/golang-devops/go-watcher`

  Install the binary under go/bin folder:

  `go install github.com/golang-devops/go-watcher/cmd/watcher`
